...
- El Engineer de tres UNet recibe `(x_t, fz)` y `999t`. Predice `uz`, seis campos de membrana y seis de flexión. Sus pérdidas supervisada y física se conservan. El peso temporal del residuo físico es ahora `t^p`, porque `t=1` es la geometría limpia.
